...
public class UserPerformancen{
	...
	public set(int id,int syear,int smonth,int userid,double saleValue,double saleNum,double extractValue,double extraValue,double givenValue,double sale1,double sale2,double exchange){
		this.id=id;
		this.syear=syear;
		this.smonth=smonth;
		this.userid=userid;
